...
export default function ModuleLayout({ title, subtitle, color, children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#020617] flex flex-col font-sans transition-colors duration-500">
      <Navbar />
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <button 
            ...
            className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900 dark:text-slate-400 dark:hover:text-white transition"
          >
            ← Back to Campus
          </button>
        </div>
        ...
        {/* Content Area */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-sm border border-gray-100 dark:border-white/5 min-h-[400px]">
          {children}
        </div>
      </main>
    </div>
